...
class UserSystemController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('UserSystem');
	...
	{
		$model=UserSystem::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserSystem $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-system-form')
		{
