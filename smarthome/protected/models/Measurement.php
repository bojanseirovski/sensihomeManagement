...
class Measurement extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('sensor_id, value, date_measured, message', 'required'),
			array('sensor_id, sensor', 'numerical', 'integerOnly'=>true),
			array('value', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, sensor_id, value, date_measured, message, sensor', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('date_measured',$this->date_measured,true);
		$criteria->compare('message',$this->message,true);
		$criteria->compare('sensor',$this->sensor);
