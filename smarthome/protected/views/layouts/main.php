...
<html>
    <head>
        ...
        <link  rel="stylesheet" type="text/css" href="<?=	$baseUrl;	?>/js/jquery-ui/jquery-ui.min.css" />
        ...
        <script type="text/javascript" src="<?=	$baseUrl;	?>/js/jquery-ui/jquery-ui.min.js"></script>
    </head>
