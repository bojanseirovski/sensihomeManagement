...
<div class="form">
	...
	<?= CHtml::dropDownList('Sensor[type]', $model->type, $sType->getTypeIdName(), ['class' => 'form-control']); ?>
	<?= $form->error($model, 'type'); ?>
    </div>

    <div class="row">
	<?= $form->labelEx($model, 'unit'); ?>
	<?= $form->textField($model, 'unit', array('size' => 60, 'maxlength' => 255, 'class' => 'form-control')); ?>
	<?= $form->error($model, 'unit'); ?>
    </div>
