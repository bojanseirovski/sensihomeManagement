...
function sendMail($settings, $recipient, $content) {
    ...
    $mail->setFrom($settings['username'], $settings['name']);
    $mail->addReplyTo($settings['username'], $settings['name']);
    $mail->addAddress($recipient['username'], $recipient['name']);
